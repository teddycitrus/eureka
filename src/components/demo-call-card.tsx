...
/**
 * Recruiter-facing demo card. POSTs to /api/demo/call-me which places a real
 * Vapi call (rate-limited + region-whitelisted server side) and follows up
 * with an SMS summary once the call ends.
 */
